...
struct WOG_API FSkelMeshMergeSectionMapping_BP
{
    GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct WOG_API FSkelMeshMergeUVTransform
{
    GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct WOG_API FSkelMeshMergeUVTransformMappings
{
    GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct WOG_API FSkeletalMeshMergeParams
{
    GENERATED_BODY()
...
*/
UCLASS()
class WOG_API UMeshMergeFunctionLibrary : public UBlueprintFunctionLibrary
{
    GENERATED_BODY()
public:
    /**
